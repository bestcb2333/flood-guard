...
<template>
  <div class="p-4">
	...
	<el-row :gutter="25" class="my-3">
		<el-col :xs="24" :sm="16">
			<el-card title="概览" :center="true" class="nav-home">
				<el-row>
			...
			<el-card class="nav-home" title="内涝地图" minHeight="600px" :center="true">
				<img src="../assets/map.jpg" style="height: 300px;" />
			</el-card>
		</el-col>

	  	<el-col :xs="24" :sm="8">
			<el-card class="nav-home" title="公告" minHeight="400px">
